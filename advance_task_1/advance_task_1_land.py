...
import advance_task_1.advance_task_1_params as params

class advance_task_1_land_fsm(base_fsm):
    def enter_state(self, flight):
        flight.median_filter.refresh()

    def exec_state(self, flight):
        advance_task_1_land(flight)

    def exit_state(self, flight):
        pass

advance_task_1_land_counter = 0

def advance_task_1_land(flight):
    global advance_task_1_land_counter
    if advance_task_1_land_counter < params.ADVANCE_TASK_1_LAND_NUM:
        angle = 120
